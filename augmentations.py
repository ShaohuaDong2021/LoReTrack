...
class RandomCrop(nn.Module):
    def __init__(self, size, output_size):
        ...
        self.h = output_size
        self.w = output_size
        self.i = random.randint(0, size - output_size)
        self.j = random.randint(0, size - output_size)
    def forward(self, img):
        sample = F.crop(img, self.i, self.j, self.h, self.w)
        return sample
...
#         # print(img.shape, "ppppppppppppppppppppppp")
#         # print(img[0].shape, "000000000000000000000000000000000")
#         # print(img[1], "111111111111111111111111111")
#         # print(img[2], "22222222222222222222222222222")
#         # print(img[3], "333333333333333333333333333")
#         img = img[0]
#         w, h = img[2], img[3]
#         print(w.shape, "11111111111111111111111")
#         print(h.shape, "22222222222222222222222")
#         th, tw = output_size
#         # if w == tw and h == th:
#         #     return 0, 0, h, w
#
...
#
#         i, j, h, w = self.get_params(sample, self.size)
