...
# DATA.SEARCH_TEACHER
cfg.DATA.SEARCH_teacher = edict()
cfg.DATA.SEARCH_teacher.SIZE = 384
cfg.DATA.SEARCH_teacher.FACTOR = 5.0
cfg.DATA.SEARCH_teacher.CENTER_JITTER = 4.5
cfg.DATA.SEARCH_teacher.SCALE_JITTER = 0.5
# DATA.TEMPLATE
...
# DATA.TEMPLATE_teacher
cfg.DATA.TEMPLATE_teacher = edict()
cfg.DATA.TEMPLATE_teacher.SIZE = 192
cfg.DATA.TEMPLATE_teacher.FACTOR = 2.0
cfg.DATA.TEMPLATE_teacher.CENTER_JITTER = 0
cfg.DATA.TEMPLATE_teacher.SCALE_JITTER = 0
...
cfg.TEST.TEMPLATE_SIZE_teacher = 192
cfg.TEST.SEARCH_FACTOR = 5.0
cfg.TEST.SEARCH_SIZE = 320
cfg.TEST.SEARCH_SIZE_teacher = 384
cfg.TEST.EPOCH = 500
