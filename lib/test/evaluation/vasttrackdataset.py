...
class VastTrackDataset(BaseDataset):
    ...
    def __init__(self):
        ...
        self.txt_file_path = '/home/UNT/sd1260/OSTrack_new4A6000_2/lib/test/utils/vasttrack_test_list_test.txt'  # here is the vast txt file path
    ...
    def clean_seq_list(self):
        ...
        for i in range(len(self.sequence_list)):
            cls, _ = self.sequence_list[i].rsplit('-', 1)  # more than one '-'
