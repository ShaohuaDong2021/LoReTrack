...
class STARKProcessing(BaseProcessing):
    ...
    def __call__(self, data: TensorDict):
        ...
        # numpy_image = data['search_images'][0].detach().cpu().numpy().permute(1, 2, 0)
        # im = Image.fromarray(numpy_image)
        # im.save("/home/UNT/sd1260/OSTrack/lib/train/actors/saveimage1/image5.jpeg")
        # # print(data['search_images'][0].shape, "1111111111111111111111")
        # # print(data['search_anno'], "1111111111111111111")
