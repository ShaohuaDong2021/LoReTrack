...
def main():
    ...
    parser.add_argument('--script', type=str, required=True, default='ostrack', help='ostrack')
    parser.add_argument('--config', type=str, required=True, default='vitb_128_mae_32x4_ep300_1', help="Name of the config file.")
