...
"""ostrack"""
# trackers.extend(trackerlist(name='ostrack_previous.py', parameter_name='vitb_128_mae_32x4_ep300', dataset_name=dataset_name,
#                             run_ids=None, display_name='OSTrack128'))
# trackers.extend(trackerlist(name='ostrack_previous.py', parameter_name='vitb_192_mae_32x4_ep300', dataset_name=dataset_name,
#                             run_ids=None, display_name='OSTrack192'))
# trackers.extend(trackerlist(name='ostrack_previous.py', parameter_name='vitb_256_mae_32x4_ep300', dataset_name=dataset_name,
#                             run_ids=None, display_name='OSTrack256'))
trackers.extend(trackerlist(name='ostrack', parameter_name='vitb_384_mae_32x4_ep300', dataset_name=dataset_name,
                            run_ids=None, display_name='OSTrack384'))


# trackers.extend(trackerlist(name='ostrack_previous.py', parameter_name='vitb_128_mae_ce_32x4_ep300', dataset_name=dataset_name,
#                             run_ids=None, display_name='OSTrack256'))
# trackers.extend(trackerlist(name='ostrack_previous.py', parameter_name='vitb_192_mae_ce_32x4_ep300', dataset_name=dataset_name,
#                             run_ids=None, display_name='OSTrack256'))
# trackers.extend(trackerlist(name='ostrack_previous.py', parameter_name='vitb_256_mae_ce_32x4_ep300', dataset_name=dataset_name,
#                             run_ids=None, display_name='OSTrack256'))
# trackers.extend(trackerlist(name='ostrack_previous.py', parameter_name='vitb_384_mae_ce_32x4_ep300', dataset_name=dataset_name,
#                             run_ids=None, display_name='OSTrack384'))
